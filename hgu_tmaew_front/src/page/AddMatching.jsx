...
export default function AddMatching() {
  ...
  const handlePost = async () => {
    ...
    try {
      const response = await axios.post(
        'https://likelion.info:443/match/add', // Replace with your API endpoint
        formData,
        {
          headers: {
      ...
      if (response.status === 200) {
        ...
        alert("게시물 업로드 성공");
        navigate('/dashboard/teammatch'); // Navigate back to the library page after successful post
      } else {
